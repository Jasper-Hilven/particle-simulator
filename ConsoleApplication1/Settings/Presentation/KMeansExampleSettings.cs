...
{
    public class KMeansExampleSettings
    {
        ...
        public KMeansExampleSettings(BasicSettingsFactory basicSettings, CostSettingsFactory costSettingsFactory, ParticlePositionFactory particlePositionFactory, SimulationTypeFactory simulationTypeFactory)
        {
        ...
        public IEnumerable<InitializationParameters> GetCase5Settings()
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                particlePositionFactory.SetBallDistribution(retPar, new Vector3(0.5f, 0.2f, 0.5f), 0.5f, 0.03f);
                ...
                retPar.VisualizationParameters.MainOutputPath =
                    @"C:\Users\Jasper\Documents\School\Thesis\ArticleMarchKMeansDemo" + i + "\\";
                ...
                if(i == 1)
                    simulationTypeFactory.SetMatrixSettings(retPar,1,6);//1 is a valid number for comparison
